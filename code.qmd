...
pipeline %>% 
  image_write(format = "jpg", "files/Fig1.jpg")
...
plot %>% 
  ggsave2(filename = c("files/Fig2.jpg")
...
plot %>% 
  plot_grid() %>% 
  ggsave2(filename = c("files/FigS1.jpg")
         , plot = ., width = 20, height = 20, units = "cm")

include_graphics("files/FigS1.jpg")
```
...
include_graphics("files/Fig3.jpg")
```
