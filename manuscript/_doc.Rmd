...
\newpage
```{r}
knitr::include_graphics('manuscript/img_1.png{#fig:id.pmcc7d4jkx1a}')
```
\newpage
```{r}
knitr::include_graphics('manuscript/img_2.png{#fig:id.6pfwogtac6re}')
```
\newpage
```{r}
knitr::include_graphics('manuscript/img_0.png{#fig:kix.496kixf5gqtx}')
```
\newpage
```{r}
knitr::include_graphics('manuscript/img_3.png{#fig:id.y18qqmtszisb}')
```
